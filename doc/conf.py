...
html_context = {
    ...
    'github_repo': 'docker-mfextaddon_python3_ia-centos7-buildimage',
...
project = u'docker-mfextaddon_python3_ia-centos7-buildimage'
...
htmlhelp_basename = 'docker-mfextaddon_python3_ia-centos7-buildimagedoc'
...
latex_documents = [
    (master_doc, 'docker-mfextaddon_python3_ia-centos7-buildimage.tex',
     u'docker-mfextaddon_python3_ia-centos7-buildimage Documentation',
     u'MetWork', 'manual'),
]
...
man_pages = [
    (master_doc, 'docker-mfextaddon_python3_ia-centos7-buildimage', u'docker-mfextaddon_python3_ia-centos7-buildimage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'docker-mfextaddon_python3_ia-centos7-buildimage', u'docker-mfextaddon_python3_ia-centos7-buildimage Documentation',
     author, 'docker-mfextaddon_python3_ia-centos7-buildimage', 'One line description of project.',
     'Miscellaneous'),
]
